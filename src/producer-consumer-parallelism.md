...
### Reading in lines
Read in one line at a time. Trim the read in line (e.g. remove newlines) and then send it together with the line number to the work channel (clone the string).
